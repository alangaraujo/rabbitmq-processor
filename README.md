...
*No arquivo, estão as configurações para usar o ambiente de homologação, caso seja utilizado em ambiente de produção, utilize o hostname e porta do exemplo abaixo.*  
